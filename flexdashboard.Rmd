...
```{r fig.align= 'center', fig.width= 7, fig.cap="Percentage of children out of school in primary school age"}
...
```{r fig.align= 'center', fig.width= 7, fig.cap="Percentage of children out of school in primary school age by gender"}
os_gender <- os_clean %>% 
